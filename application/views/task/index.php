                    ...
                    <div class="span8">
                        ...
                        <div class="widget">
                            <div class="widget-head">
                                <div class="pull-left">New Task</div>
                            ...
                            <div class="widget-content">
                                <div class="padd">
                                    ...
                                    <?php echo form_open_multipart('task/add'); ?>
                                        <?php echo form_input($title); ?>
                                        <br />
                                        <?php echo form_dropdown('priority',$priority['options']); ?>
                                        <br />
                                        <button type="button" class="btn add-media"><i class="icon-paper-clip"></i> Add Media</button>
                                        <span class="alert-info file-name"></span>
                                        <div class="hidden">
...
<script>
    $(function(){
        ...
        $("form").submit(function(){
            ...
            if(file == "")
            {
                $(".file-name").html("Please select a file");
                return false;
            }
            return true;
        });
